...
*  - should return the threads with the neutral vote thread when given by NEUTRAL_VOTE_THREAD action
*
*/
...
describe('threadReducers function', () => {
  ...
  it('should return the threads with the neutral vote thread when given by NEUTRAL_VOTE_THREAD action', () => {
    // arrange
    const initialState = [
      {
        id: 'thread-1',
